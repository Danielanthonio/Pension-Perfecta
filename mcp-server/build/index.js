 ...
 */
server.tool("list_prospects", "Obtiene una lista de prospectos del sistema. Permite filtrar opcionalmente por estatus.", {
 ...
 */
server.tool("get_prospect_detail", "Obtiene todos los detalles de un prospecto específico por su ID, incluyendo NSS, CURP y datos financieros de simulación Ley 73.", {
 ...
 */
server.tool("update_prospect_status", "Actualiza el estatus de un prospecto en la base de datos y permite opcionalmente añadir notas del director o del aliado.", {
    prospect_id: z.string().uuid().describe("El UUID único del prospecto"),
 ...
 */
server.tool("create_prospect", "Crea un nuevo prospecto en el sistema. Útil para sincronizaciones desde CRMs hacia Pensión Perfecta.", {
