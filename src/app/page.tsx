...
import { ArrowRight, CheckCircle2, TrendingUp, ShieldAlert, Award, FileSpreadsheet, Users } from "lucide-react";

export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 text-white overflow-hidden relative selection:bg-blue-500 selection:text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-20 pb-24 relative z-10 flex flex-col items-center text-center">
        <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-blue-500/10 text-blue-400 border border-blue-500/20 mb-8 animate-fade-in shadow-inner">
        ...
        <p className="mt-8 text-base md:text-xl text-slate-400 max-w-2xl leading-relaxed">
          PensiónFlow centraliza la carga de prospectos, la simulación técnica Ley 73, el agendamiento integrado y el control visual del pipeline en un solo lugar.
        </p>

        <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
          <Link
            href="/login"
            className="group px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white rounded-2xl text-base font-bold shadow-lg shadow-blue-500/25 transition-all flex items-center gap-2 hover:scale-[1.02]"
          >
            Ingresar al Portal
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-slate-900/80 border border-white/5 rounded-2xl p-6 shadow-2xl relative">
              <div className="flex items-center justify-between border-b border-white/5 pb-4 mb-6">
                ...
                <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">PensiónFlow Console</span>
              </div>
