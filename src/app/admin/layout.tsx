      ...
      <header className="h-20 bg-[#0f172a] text-slate-350 flex items-center justify-between px-6 sm:px-10 flex-shrink-0 z-20 shadow-md border-b border-slate-800">
        ...
        <div className="flex items-center gap-4.5">
          ...
          >
            ...
            {unreadNotifsCount > 0 && (
              <span className="absolute top-[-2px] right-[-2px] h-4.5 min-w-[18px] px-1 rounded-full bg-teal-500 text-white font-extrabold text-[9px] flex items-center justify-center animate-bounce border border-slate-900 shadow-sm">
                {unreadNotifsCount}
              </span>
            )}
          </button>
          ...
          {user && (
            ...
            >
              <div className="text-right hidden sm:block">
                ...
                <span className="inline-block text-[8px] font-extrabold text-teal-400 bg-teal-500/10 border border-teal-500/20 rounded-full px-2.5 py-1 mt-1.5 leading-none uppercase tracking-widest font-sans">
                  Director
                </span>
              </div>
