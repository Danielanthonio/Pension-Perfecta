...
import { useApp, STAGES_LIST, SUB_STAGES_BY_STAGE, getProfileCompletion, getBankingCompletion } from "@/utils/context/AppContext";
import {
  LayoutDashboard,
  Folder,
  Plus,
    ...
    <div className={`pt-8 border-t border-slate-800/55 mt-6 space-y-4 ${collapsed ? "md:hidden" : ""}`}>
      ...
      <div className="mx-3 p-3.5 space-y-3 rounded-2xl bg-slate-900/50 border border-slate-800/70 shadow-inner shadow-black/20">
        ...
        <div className="space-y-2.5 pt-2">
          ...
          {/* Modalidad de aprobación / tipo de financiamiento — solo en la lista de clientes */}
          {isClientes && (
            <div>
