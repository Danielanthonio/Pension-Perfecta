    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 flex items-center justify-center py-12 px-6 relative overflow-hidden select-none">
      ...
      <div className="max-w-md w-full bg-white/[0.03] backdrop-blur-xl border border-white/5 p-8 md:p-10 rounded-3xl shadow-2xl relative z-10 flex flex-col">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-500/10 border border-blue-500/20 text-3xl mb-4">
            🏦
          </div>
        ...
        <div className="bg-gradient-to-br from-blue-500/10 via-indigo-500/5 to-slate-900/5 border border-blue-500/20 rounded-2xl p-5 mb-6 relative overflow-hidden group">
          <div className="absolute top-[-30px] right-[-30px] w-20 h-20 bg-blue-500/10 rounded-full blur-xl group-hover:scale-125 transition-transform" />
          <h3 className="text-xs font-bold text-blue-400 uppercase tracking-widest flex items-center gap-1.5 mb-4">
        ...
        <div className="relative flex items-center justify-center my-4">
          ...
          <span className="absolute bg-[#0f172a] px-3 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
            O ingresar correo
          </span>
        </div>
        ...
        <form onSubmit={handleFormLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-6 py-3 px-4 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-bold rounded-xl transition-all shadow-md shadow-blue-500/10 flex items-center justify-center gap-2"
          >
